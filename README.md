...
`Group_4_Robot_Code_Final_Project.ino` | Main code for the robot. It has the pin setup, remote controls, motor functions, sensor readings, buzzer sounds, and all the robot modes.
...
5. Open `Group_4_Robot_Code_Final_Project.ino`.
